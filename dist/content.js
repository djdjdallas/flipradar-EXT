(()=>{var S="flipchecker-overlay",R="flipchecker-trigger",f="https://www.flipchecker.io";var x={currentUrl:typeof window<"u"?window.location.href:null,authToken:null,currentUser:null,lastExtractedData:null,currentJobId:null,isExtracting:!1};function A(e){x={...x,...e}}function y(){return x.authToken}function we(){return x.currentUser}function Ce(e){x.lastExtractedData=e}function B(){return x.lastExtractedData}function Ee(){x.lastExtractedData=null}function Te(){let e=Date.now()+"_"+Math.random().toString(36).substr(2,9);return x.currentJobId=e,x.isExtracting=!0,e}function _(e){return x.currentJobId===e}function M(e){x.currentJobId===e&&(x.isExtracting=!1)}var te=typeof window<"u"?window.location.href:"",ee=null,q=null,Se=!1,Le=[];function Fe(e){Le.push(e)}function xt(e=window.location.href){let t=e.match(/\/marketplace\/item\/(\d+)/);return t?t[1]:null}function oe(e=window.location.href){return e.includes("/marketplace/item/")}function yt(){let e=document.getElementById(R),t=document.getElementById(S);e&&e.remove(),t&&t.remove()}function Ie(e,t){Le.forEach(o=>{try{o(e,t)}catch{}})}function G(){let e=window.location.href;if(oe(e)){let t=xt(e),r=B()?.itemId;t!==r&&Ee(),Ie(e,t)}else yt(),Ie(e,null)}function kt(){let e=history.pushState,t=history.replaceState;history.pushState=function(...o){e.apply(this,o),G()},history.replaceState=function(...o){t.apply(this,o),G()},window.addEventListener("popstate",G)}function bt(){q&&(q.disconnect(),q=null);let e=new MutationObserver(()=>{ee&&clearTimeout(ee),ee=setTimeout(()=>{window.location.href!==te&&(te=window.location.href,G())},100)});return e.observe(document.body,{childList:!0,subtree:!0}),q=e,e}function Ae(){Se||(Se=!0,te=window.location.href,kt(),bt())}var Be=new Map,_t=[];function Me(e){return Be.get(e)||null}function vt(e){try{let t=typeof e=="string"?JSON.parse(e):e;if(t?.data?.marketplace_product_details_page){let o=t.data.marketplace_product_details_page;return{itemId:o.id,title:o.marketplace_listing_title,price:o.listing_price?.amount,priceFormatted:o.listing_price?.formatted_amount,currency:o.listing_price?.currency,location:o.location?.reverse_geocode?.city||o.location_text?.text,seller:o.marketplace_listing_seller?.name,description:o.redacted_description?.text,images:o.listing_photos?.map(r=>r.image?.uri).filter(Boolean),condition:o.condition,category:o.marketplace_listing_category_id,source:"graphql"}}if(t?.data?.node?.__typename==="MarketplaceListing"){let o=t.data.node;return{itemId:o.id,title:o.marketplace_listing_title,price:o.listing_price?.amount,priceFormatted:o.listing_price?.formatted_amount,location:o.location_text?.text,seller:o.story?.comet_sections?.seller?.seller?.name,images:o.listing_photos?.map(r=>r.image?.uri).filter(Boolean),source:"graphql"}}if(t?.data?.marketplace_pdp?.product){let o=t.data.marketplace_pdp.product;return{itemId:o.id,title:o.title||o.name,price:o.price?.amount,priceFormatted:o.price?.formatted,location:o.location,seller:o.seller?.name,images:o.images?.map(r=>r.uri||r.url).filter(Boolean),source:"graphql"}}return null}catch{return null}}function wt(e,t){Be.set(e,t),_t.forEach(o=>{try{o(e,t)}catch{}})}function Pe(){window.addEventListener("message",e=>{if(e.source===window&&e.data?.type==="FLIPCHECKER_GRAPHQL_RESPONSE"){let t=vt(e.data.data);t&&t.itemId&&wt(t.itemId,t)}})}var $e={tier1:['[data-testid="marketplace_pdp_title"]','[data-testid="marketplace_pdp_component"] h1'],tier2:["span.x1lliihq.x6ikm8r.x10wlt62.x1n2onr6:not(.xlyipyv)",'[data-testid="marketplace_pdp_component"] span[dir="auto"]','div[role="main"] span.x1lliihq.x6ikm8r.x10wlt62'],tier3:['div[role="main"] h1','h1[dir="auto"]','[role="heading"][aria-level="1"]']};var De={tier1:['[data-testid="marketplace_pdp_location"]','[data-testid="marketplace_pdp-location"]'],tier2:['span[dir="auto"]','a[href*="/marketplace/"]'],tier3:[]},Re={tier1:['[data-testid="marketplace_pdp_seller_name"]','[data-testid="marketplace_pdp-seller_profile_link"]','a[href*="/marketplace/profile/"] span'],tier2:['a[role="link"][href*="/profile.php"] span','a[role="link"][href*="facebook.com/"][href*="/"]'],tier3:[]},Ne={tier1:['img[data-testid="marketplace_pdp_image"]','[data-testid="marketplace_pdp-image"] img'],tier2:['div[role="main"] img[style*="object-fit"]','div[role="main"] div[aria-label] img[src*="scontent"]','div[role="main"] div[data-pagelet] img[src*="scontent"]'],tier3:['div[role="main"] img[src*="scontent"]','img[src*="scontent"]']};function N(e){return[...e.tier1||[],...e.tier2||[],...e.tier3||[]]}var re=/^\$[\d,]+(\.\d{2})?$/,Ue=[/Listed in (.+)/i,/Location: (.+)/i,/in ([A-Z][a-z]+,?\s*[A-Z]{2})/],Oe=[/Listed (\d+) (day|week|hour|minute)s? ago/i,/(\d+) (day|week|hour|minute)s? ago/i];var Et=["marketplace","facebook marketplace","listing","item","product","details","seller details","description","about this item","chat history is missing","message seller","send message","is this still available","see more","see less","show more","sponsored","suggested for you","similar items","related items"],Tt=[/^(send|chat|message|call|contact)/i,/^(see|view|show|hide|load)\s+(more|less|all)/i,/facebook/i,/messenger/i,/^(listed|posted|sold)\s+(in|on|ago)/i,/^\d+\s+(views?|likes?|saves?|comments?)/i,/^(share|save|report|hide)\s*(this)?/i,/history is (missing|unavailable)/i,/^(sign|log)\s*(in|out|up)/i,/^(join|create|start)/i,/enter your pin/i,/restore chat/i,/end-to-end encrypted/i,/^\d+\s*(new\s*)?(message|notification)/i,/your (message|chat|conversation)/i,/turn on notifications/i,/^\s*•\s*/,/^(tap|click|press)\s+(to|here)/i,/learn more$/i];function P(e){if(!e)return!0;let t=e.toLowerCase().trim();if(Et.includes(t))return!0;for(let o of Tt)if(o.test(e))return!0;return e.length<5}function ze(e,t){if(!e||!t)return!1;let o=/iphone|ipad|macbook|playstation|ps5|xbox|nintendo|airpods/i;return e<10&&o.test(t)}function se(e){let t=window.getComputedStyle(e);return parseFloat(t.fontSize)||0}function W(){return document.querySelector('div[role="main"]')}function qe(e=1e4){let t=W();return t?t.innerText.substring(0,e):document.body.innerText.substring(0,e)}function v(e){if(!e)return"";let t=document.createElement("div");return t.textContent=e,t.innerHTML}function ae(e){if(!e)return"#";try{let t=new URL(e);return["https:","http:"].includes(t.protocol)?e:"#"}catch{return"#"}}function b(e){if(!e)return null;if(e.toLowerCase()==="free")return 0;let t=e.replace(/[^0-9.]/g,""),o=parseFloat(t);return isNaN(o)?null:o}function w(e){return e==null?"N/A":e===0?"Free":"$"+e.toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0})}function H(e){if(!e)return null;let t=e.replace(/[^\w\s-]/g," ").replace(/\s+/g," ").trim().substring(0,100);return`https://www.ebay.com/sch/i.html?_nkw=${encodeURIComponent(t)}&LH_Complete=1&LH_Sold=1&_sop=13`}function ce(e,t,o,r=.84){return t==null||o==null||e==null?{low:null,high:null}:{low:Math.round(t*r-e),high:Math.round(o*r-e)}}function pe(e,t){return t<0?"profit-negative":e<0?"profit-mixed":"profit-positive"}function de(e,t=24*60*60*1e3){return e?Date.now()-e<t:!1}function j(){let e=window.location.href.match(/\/marketplace\/item\/(\d+)/);return e?e[1]:null}function V(){return window.location.href.includes("/marketplace/item/")}function He(e,t,o=5e3,r=null){return new Promise(n=>{let s=Date.now(),i=B();if(i?.itemId===t&&i?.title){n(!0);return}let a=()=>{if(r&&!_(r)){n(!1);return}let l=je(),p=Date.now()-s,k=P(l);if(l&&!k&&l!==e&&p>=500){n(!0);return}if(!e&&l&&!k&&p>=500){n(!0);return}if(p>o){n(!1);return}setTimeout(a,200)};a()})}function Lt(){let e=document.title||"";if(!e)return null;let t=e.replace(/\s*[\|\-]\s*(Facebook|Marketplace).*$/i,"").trim();if(!t||t.length<5)return null;let o=t.replace(/\s*[-–]\s*\$[\d,]+.*$/,"").trim();return o&&o.length>=5&&(t=o),P(t)||t.startsWith("$")||/^\d+$/.test(t)?null:t}function Ft(){let t=(document.title||"").match(/\$[\d,]+/);if(t){let o=b(t[0]);if(o>=5)return o}return null}function je(){let e=Lt();if(e)return e;let t=N($e);for(let n of t)try{let s=document.querySelectorAll(n);for(let i of s){let a=i.textContent.trim();if(a.length>15&&a.length<300&&!a.startsWith("$")&&!/^\d+$/.test(a)&&!P(a))return a}}catch{}let o=W();if(o){let n=o.querySelectorAll('span[dir="auto"]'),s=[];for(let i of n){let a=i.textContent.trim();if(a.length>15&&a.length<200&&!a.startsWith("$")&&!P(a)&&!/^\d+$/.test(a)){let l=se(i);s.push({text:a,fontSize:l,element:i})}}if(s.sort((i,a)=>a.fontSize-i.fontSize),s.length>0)return s[0].text}let r=document.querySelectorAll('h1, h2, [role="heading"]');for(let n of r){let s=n.textContent.trim();if(s.length>10&&s.length<300&&!P(s)&&!s.startsWith("$"))return s}return null}function At(){let e=Ft();if(e)return e;let t=document.querySelector("h1");if(t){let s=t.closest("div");if(s){let i=s.parentElement?.querySelectorAll("span")||[];for(let a of i){let l=a.textContent.trim();if(re.test(l))return b(l)}}}let o=document.querySelectorAll("span"),r=[];for(let s of o){let i=s.textContent.trim();if(re.test(i)){let a=se(s),l=b(i);r.push({element:s,price:l,fontSize:a})}}if(r.sort((s,i)=>i.fontSize-s.fontSize),r.length>0){let s=r.find(i=>i.price>=5&&i.fontSize>=14);return s?s.price:r[0].price}let n=W();if(n){let i=n.innerText.match(/\$[\d,]+(\.\d{2})?/);if(i)return b(i[0])}return null}function Bt(){let e=N(De);for(let t of e)try{let o=document.querySelectorAll(t);for(let r of o){let n=r.textContent.trim();for(let s of Ue){let i=n.match(s);if(i)return i[1]||n}if(/^[A-Z][a-z]+,?\s*[A-Z]{2}$/.test(n))return n}}catch{}return null}function Mt(){let e=N(Re);for(let t of e)try{let o=document.querySelector(t);if(o&&o.textContent.trim()&&o.textContent.trim().length<50)return o.textContent.trim()}catch{}return null}function Pt(){let e=document.querySelectorAll("span");for(let t of e){let o=t.textContent.trim();for(let r of Oe)if(r.test(o))return o}return null}function L(){let t=N(Ne);for(let o of t)try{let r=document.querySelectorAll(o),n=null,s=0;for(let i of r){if(!i.src)continue;let a=i.naturalWidth||i.width||0,l=i.naturalHeight||i.height||0,p=Math.max(a,l);p>=200&&p>s&&(n=i.src,s=p)}if(n)return n}catch{}return null}function Ve(e){return{title:je(),price:At(),location:Bt(),seller:Mt(),daysListed:Pt(),imageUrl:L(),itemId:e,source:"dom"}}async function Je(){let e=y();return e?new Promise(t=>{let o=qe(1e4);chrome.runtime.sendMessage({type:"apiRequest",url:`${f}/api/extract`,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:{pageText:o,url:window.location.href}},r=>{if(chrome.runtime.lastError){t(null);return}if(!r){t(null);return}if(!r.ok){t(null);return}t(r.data)})}):null}function Xe(e,t){return{title:e.title||null,price:typeof e.price=="number"?e.price:b(e.price),location:e.location||null,seller:e.seller||null,daysListed:e.daysListed||null,imageUrl:L(),itemId:t,source:"ai"}}function $t(){return new Promise(e=>{chrome.runtime.sendMessage({type:"captureScreenshot"},t=>{if(chrome.runtime.lastError){e(null);return}if(!t||!t.success){e(null);return}e(t.screenshot)})})}async function Ye(){let e=y();if(e||(e=(await new Promise(r=>chrome.storage.local.get(["authToken"],r)))?.authToken||null,e&&A({authToken:e})),!e)return null;let t=await $t();return t?new Promise(o=>{chrome.runtime.sendMessage({type:"apiRequest",url:`${f}/api/vision-extract`,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${e}`},body:{screenshot:t,url:window.location.href}},r=>{if(chrome.runtime.lastError){o(null);return}if(!r){o(null);return}if(!r.ok){o(null);return}r.data?.error,o(r.data)})}):null}function Ke(e,t){return{title:e.title||null,price:typeof e.price=="number"?e.price:b(e.price),location:e.location||null,seller:e.seller||null,daysListed:e.daysListed||null,imageUrl:L(),itemId:t,source:"vision"}}async function X(e){let t=y();return t?new Promise(o=>{chrome.runtime.sendMessage({type:"apiRequest",url:`${f}/api/price-lookup`,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`},body:{query:e}},r=>{if(chrome.runtime.lastError){o({error:"network_error"});return}if(!r){o({error:"network_error"});return}if(r.status===401){o({error:"auth_required"});return}if(r.status===429){o({error:"limit_reached",message:r.data?.error});return}if(!r.ok){o({error:"api_error"});return}let n=r.data;o({source:n.source,ebay_low:n.prices?.low,ebay_high:n.prices?.high,ebay_avg:n.prices?.avg,ebay_median:n.prices?.median,sample_count:n.prices?.sample_count,samples:n.samples,ebay_url:n.ebay_search_url,usage:n.usage})})}):{error:"auth_required"}}async function Qe(e,t){let o=y();return o?new Promise(r=>{chrome.runtime.sendMessage({type:"apiRequest",url:`${f}/api/deals`,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${o}`},body:{url:window.location.href,title:e.title,price:e.price,itemId:e.itemId,extractionMethod:e.source,location:e.location,sellerName:e.seller,images:e.images||(e.imageUrl?[e.imageUrl]:null),ebay_search_url:t&&!t.error&&t.ebay_url||null,priceData:t&&!t.error?{ebayLow:t.ebay_low,ebayHigh:t.ebay_high,ebayAvg:t.ebay_avg}:null}},n=>{if(chrome.runtime.lastError){J(e),r({success:!0,local:!0});return}if(!n||!n.ok){if(n?.status===401){J(e),r({success:!0,local:!0});return}if(n?.status===429){r({success:!1,error:"Deal limit reached. Upgrade to save more."});return}J(e),r({success:!0,local:!0});return}r({success:!0})})}):(J(e),{success:!0,local:!0})}function J(e){let t={id:Date.now()+"_"+Math.random().toString(36).substr(2,9),title:e.title||"Unknown Item",price:e.price,url:window.location.href,imageUrl:e.imageUrl||e.images&&e.images[0]||null,ebayUrl:H(e.title),savedAt:new Date().toISOString()};chrome.storage.local.get(["savedDeals"],o=>{let r=o.savedDeals||[];r.unshift(t),r.length>100&&r.pop(),chrome.storage.local.set({savedDeals:r},()=>{chrome.runtime.lastError})})}async function et(e){return new Promise(t=>{if(!e){t(null);return}let r=`flipchecker_sold_${e.toLowerCase().replace(/[^\w\s]/g," ").replace(/\s+/g,"_").substring(0,50)}`;chrome.storage.local.get([r,"flipchecker_last_sold"],n=>{if(n[r]&&de(n[r].timestamp,864e5)){t(n[r]);return}if(n.flipchecker_last_sold&&de(n.flipchecker_last_sold.timestamp,864e5)){let s=n.flipchecker_last_sold.query.toLowerCase(),i=e.toLowerCase(),a=s.split(/\s+/).filter(u=>u.length>3),l=i.split(/\s+/).filter(u=>u.length>3),p=a.filter(u=>l.some(m=>m.includes(u)||u.includes(m)));if((l.length>0?p.length/l.length:0)>=.6&&p.length>=3){t(n.flipchecker_last_sold);return}}t(null)})})}async function Rt(){return new Promise(e=>{chrome.storage.local.get(["refreshToken","user"],t=>{if(!t.refreshToken){e(!1);return}chrome.runtime.sendMessage({type:"apiRequest",url:`${f}/api/auth/refresh`,method:"POST",headers:{"Content-Type":"application/json"},body:{refresh_token:t.refreshToken}},o=>{if(chrome.runtime.lastError||!o?.ok){e(!1);return}let r=o.data;if(r?.access_token){let n={authToken:r.access_token};r.refresh_token&&(n.refreshToken=r.refresh_token),chrome.storage.local.set(n,()=>{A({authToken:r.access_token,currentUser:t.user||null}),e(!0)})}else e(!1)})})})}async function Y(){return new Promise(e=>{chrome.storage.local.get(["authToken","refreshToken","user"],async t=>{if(chrome.runtime.lastError){e();return}if(t.authToken){let o=!1;try{let r=JSON.parse(atob(t.authToken.split(".")[1]));o=r.exp&&r.exp*1e3<Date.now()}catch{}o?t.refreshToken?await Rt()||chrome.storage.local.remove(["authToken","refreshToken","user"]):chrome.storage.local.remove(["authToken","user"]):A({authToken:t.authToken,currentUser:t.user||null})}e()})})}function tt(e){let t=o=>{o.type==="authSuccess"&&(A({authToken:null,currentUser:o.user}),Y().then(e))};return chrome.runtime.onMessage.addListener(t),()=>{chrome.runtime.onMessage.removeListener(t)}}function ot(e){let t=o=>{o.type==="soldDataAvailable"&&e(o.data)};return chrome.runtime.onMessage.addListener(t),()=>{chrome.runtime.onMessage.removeListener(t)}}function C(){return!!y()}function rt(){chrome.runtime.sendMessage({type:"openLogin"})}function nt(){chrome.runtime.sendMessage({type:"openUpgrade"})}function Nt(){return`
    <style>
  ...
  `}function Ut(){let e=we();if(!e)return"";let t=e.tier||"free";return t==="flipper"?'<span class="tier-badge tier-flipper">Flipper</span>':t==="pro"?'<span class="tier-badge tier-pro">Pro</span>':'<span class="tier-badge">Free</span>'}async function ue(e,t=null,o=[]){let r=j();if(e.itemId&&e.itemId!==r)return;let n=document.getElementById(S);n&&n.remove();let s=document.createElement("div");s.id=S;let i=s.attachShadow({mode:"open"}),a=t&&!t.error,l=C(),p=t?.error==="limit_reached",k=a&&t.ebay_low!=null&&t.ebay_high!=null,u=null,m=null,z="profit-positive";if(k&&e.price){let c=ce(e.price,t.ebay_low,t.ebay_high);u=c.low,m=c.high,z=pe(u,m)}let ft=ze(e.price,e.title),ke=t?.ebay_url||H(e.title),mt=Ut(),be=e.imageUrl||e.images&&e.images[0]||null,g=`
    ${Nt()}
    <div class="container">
      <div class="header">
      ...
      <div class="price-section">
        ${be?`<img class="listing-image" src="${ae(be)}" alt="" />`:""}
  ...
  `;l||(g+=`
    ...
    `);let I=await et(e.title);if(I&&I.stats&&I.stats.count>0){let c=I.stats;if(e.price){let d=ce(e.price,c.low,c.high);u=d.low,m=d.high,z=pe(u,m)}if(g+=`
    ...
    <div class="buttons">
      ${ke?`<a href="${ae(ke)}" target="_blank" rel="noopener" class="btn btn-primary">Check eBay Sold Prices</a>`:""}
  ...
  `,document.body.appendChild(o),o}function fe(e){let t=document.getElementById(S);t&&t.remove();let o=document.getElementById(R);o&&o.remove();let r=document.createElement("button");r.id=R,r.innerHTML="\u{1F4B0} CHECK FLIP",r.style.cssText=`
    position: fixed;
    bottom: 80px;
    right: 20px;
    z-index: 2147483646;
  ...
  `,!document.getElementById("flipchecker-scan-styles")){let o=document.createElement("style");o.id="flipchecker-scan-styles",o.textContent="@keyframes flipchecker-spin { to { transform: rotate(360deg); } }",document.head.appendChild(o)}let t=document.createElement("span");t.textContent="Scanning watchlist...",E.appendChild(e),E.appendChild(t),document.body.appendChild(E)}function ge(){E&&(E.remove(),E=null)}function Z(){T=!0,F&&(F.disconnect(),F=null),D&&(clearTimeout(D),D=null),ge(),document.querySelectorAll("[data-flipchecker-badge]").forEach(e=>e.remove()),$=!1,O.clear(),K.clear()}async function ro(e,t){let o=null,r="none";if(!_(e))return null;let n=Me(t);if(n&&(o=n,r="graphql"),!o&&C()){let s=await Ye();if(!_(e))return null;s&&(s.title||s.price)&&(o=Ke(s,t),r="vision")}if(!o&&C()){let s=await Je();if(!_(e))return null;s&&(s.title||s.price)&&(o=Xe(s,t),r="ai")}if(!o||!o.title&&!o.price){let s=B()?.title||null;if(await He(s,t,void 0,e),!_(e))return null;o=Ve(t),r="dom"}return{data:o,method:r}}async function Q(){let e=Te(),t=window.location.href,o=j();if(it({title:"Loading...",itemId:o}),await new Promise(l=>setTimeout(l,1e3)),!_(e)||window.location.href!==t){M(e);return}await Y();let r=await ro(e,o);if(!r||!_(e)){M(e);return}let{data:n,method:s}=r;if(Ce(n),!n.title&&!n.price){await ue({title:null,price:null,itemId:o},null),M(e);return}let i=null;if(C()&&n.title&&(i=await X(n.title),!_(e))){M(e);return}let a=[];C()&&n.title&&(a=await at(n)),await ue(n,i,a),M(e)}function no(e,t){fe(()=>{Q()})}var dt=!1,xe=null,ye=null;async function ut(){dt||(dt=!0,Pe(),await Y(),chrome.runtime.onMessage.addListener((e,t,o)=>{if(e.type==="getListingImage"){let r=L();o({imageUrl:r})}return!1}),Ae(),Fe((e,t)=>{oe(e)?(Z(),no(e,t)):me(e)?(Z(),he()):Z()}),xe&&xe(),ye&&ye(),xe=tt(()=>{V()&&Q()}),ye=ot(e=>{document.getElementById("flipchecker-overlay")&&V()&&Q()}),V()?fe(()=>{Q()}):me(window.location.href)&&he())}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ut):ut();})();
